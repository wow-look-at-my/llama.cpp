...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--mmap"},
        {"--no-mmap"},
        string_format("whether to allow memory-mapping the model. device-bound weights are uploaded by DMA from the pinned mapping, or streamed through pinned buffers if the backend cannot pin host memory (default: %s)", params.use_mmap ? "enabled" : "disabled"),
        [](common_params & params, bool value) {
