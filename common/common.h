...
enum common_speculative_type {
    ...
    COMMON_SPECULATIVE_TYPE_GEMMA4_MTP,    // Gemma 4 MTP: gemma4_assistant loaded into the target, cross-attends target KV (single context)
...
struct common_params {
    ...
    bool use_mmap          = true;  // allow mmap when weights can be used directly from the mapping; device-bound weights are streamed instead
